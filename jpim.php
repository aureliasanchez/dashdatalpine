                                    ...
                                    <div class="card">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="column-container">
                                                ...
                                                <div class="text">
                                                    <p>En los últimos doce meses, el mercado inmobiliario en Pachuca ha experimentado fluctuaciones en los precios de las propiedades. A pesar de ciertas variaciones mensuales, se observa un crecimiento general del valor promedio. Desde Octubre de 2022 hasta Septiembre de 2023, ha habido un aumento acumulado del <p class="porcentaje">6.8%</p>  en el precio promedio de las propiedades. Este incremento se traduce en un valor promedio de <p class="cantidades">$ 227,650</p>, indicando un cambio significativo en la tendencia alcista de los precios a partir de Marzo de 2023.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                    <form style="text-align: center;">  
                                        <div class="d-flex align-items-center">
                                            ...
                                            <iframe width="544" height="337" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQX6HV4iKEsF0uJ-dxHXixMFO_MfPxGthAhgbiLQ6shDr3WLOJSL5BAYESXBXj-Kg/pubchart?oid=2087895515&amp;format=interactive" id="contenido13" class="oculto"></iframe>
                                            -->
