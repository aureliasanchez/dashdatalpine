    ...
    <body class="layout-default">
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <p style="text-align: center;">
                                            <iframe width="690" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=354239819&amp;format=interactive"></iframe>                                        <div class="card-header bg-white d-flex align-items-center">                                             
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <h4 class="card-header__title flex m-0">Interpretación: </h4> 
                                            <div class="text">En el año <strong>2023</strong>, el precio promedio de las propiedades en Queretaro se situó en <strong>$3,750,780.45</strong>, y se anticipa que este valor mantendrá una trayectoria de crecimiento constante, alcanzando los <strong>$6,319,283.52</strong> en el año <strong>2026</strong>.
                                            </div>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header bg-white d-flex justify-content-between align-items-center">
                                            <h4 class="card-header__title m-0">1. Precio Media Anual</h4>    
                                        </div>
                                        <p style="text-align: center;">
                                            <iframe width="759" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=1751253291&amp;format=interactive"></iframe>                                        <div class="card-header bg-white d-flex align-items-center"></div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <h4 class="card-header__title flex m-0">Interpretación: </h4>
                                            <div class="text">Los datos revelan una proyección ascendente en la plusvalía del precio promedio de las viviendas en Queretaro para los próximos años. En el año <strong>2023</strong>, se muestra un valor de <strong>$3,150,000.00</strong>, evidenciando un crecimiento significativo que se espera continúe de manera constante hasta alcanzar <strong>$5,666,082</strong> en el año <strong>2026</strong>.
                                            </div>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <ul class="nav navbar-nav align-items-center">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <p style="text-align: center;">
                                            <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=1336143664&amp;format=interactive"></iframe>                                        <div class="card-header bg-white d-flex align-items-center"></div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <h4 class="card-header__title flex m-0">Interpretación: </h4>
                                            <div class="text"> 
                                                <ul>
                                                    <li>Entre los años <strong>2019 y 2021</strong>, se observó una variación significativa en el número total de créditos, alcanzando niveles destacados durante esos años. Sin embargo, en <strong>2023</strong>, se registra una marcada disminución en el total de créditos.
                                                    </li>
                                                    <li>En cuanto a las proyecciones para las categorías <strong>"Vivienda Nueva"</strong> y <strong>"Vivienda Usada"</strong>, ambas muestran patrones similares de descenso en <strong>2023</strong>, con un ligero repunte anticipado en los años que siguen a este periodo. Se espera que la categoría de <strong>"Vivienda Nueva"</strong> experimente una recuperación progresiva, alcanzando <strong>1633</strong> créditos en el año <strong>2026</strong>, mientras que la categoría de <strong>"Vivienda Usada"</strong> se proyecta a recuperarse hasta alcanzar <strong>1283 créditos</strong> en el mismo año, después de la disminución observada en <strong>2023</strong>.</li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header bg-white d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <input type="button" class="btn btn-outline-dark" onclick="mostrar('contenido53') & ocultar('contenido63')" value="Monto total">
                                                <input type="button" class="btn btn-outline-dark" onclick="mostrar('contenido63') & ocultar('contenido53')" value="Monto promedio">
                                            </div>
                                        </div>
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">  
                                                <div class="d-flex align-items-center">       
                                                    <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=548707141&amp;format=interactive" id="contenido53"></iframe>                                                    
                                                    <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=230654497&amp;format=interactive" id="contenido63" class="oculto"></iframe>                                                </form>
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text">
                                                <ul>
                                                    <li><strong>Monto total</strong>: El monto total de créditos generales se proyecta a aumentar de <strong>$7,528,788,406.66</strong> en 2019 a <strong>$9,784,055,911.18</strong> en <strong>2026</strong>, mostrando una tendencia general de crecimiento a lo largo del periodo </li>
                                                    ...
                                                    <p>Por otro lado, los créditos destinados a la <strong>"Vivienda Usada"</strong>, aunque se registran fluctuaciones, destaca un incremento progresivo de <strong>$1,687,130,678.57</strong> en <strong>2019</strong> a <strong>$3,286,869,489.38</strong> en <strong>2026</strong>.</p>
                                                    <li><strong>Monto promedio</strong>: Para todas las categorías muestra un crecimiento constante de <strong>$1,869,577.45</strong> en <strong>2019</strong> a <strong>$2,557,254.55</strong> en <strong>2026</strong>.</li>
                                                    <p>En relación a <strong>"Vivienda Nueva"</strong> en <strong>Queretaro</strong>, se observa una trayectoria ascendente en los montos promedio por crédito a lo largo de los años proyectados. Desde <strong>$2,728,752.90</strong> en <strong>2019</strong>, se anticipa un crecimiento constante hasta alcanzar <strong>$3,179,302.88</strong> en <strong>2026</strong>.</p>
                                                    <p>En cuanto a la categoría de <strong>"Vivienda Usada"</strong>, se observa una variación en los montos promedio por crédito a lo largo de los años proyectados. Partiendo de <strong>$1,396,631.36</strong> en <strong>2019</strong>, se experimenta un aumento a <strong>$2,561,862.42</strong> en <strong>2026</strong>.</p>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                            ...
                            <div class="row">
                                <div class="col-lg-12">       
                                    <div class="card">
                                        ...
                                        <p style="text-align: center;">
                                            <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=285742269&amp;format=interactive"></iframe>                                        <div class="card-header bg-white d-flex align-items-center"></div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <h4 class="card-header__title flex m-0">Interpretación: </h4>
                                            <div class="text">
                                                <ul>
                                                    <li>La <strong>línea azul</strong> representa el porcentaje de cambio en la oferta de casas. Comienza en un <strong>80% en 2023</strong>, aumenta a un <strong>85% en 2024</strong>, y llega a un pico del <strong>93%</strong> tanto para los años <strong>2026</strong> como para el año siguiente. Esto indica un aumento significativo en la oferta de casas durante este período.</li>
                                                    <li>La línea roja representa el porcentaje de cambio en la oferta de departamentos. De acuerdo a la tendencia comienza con una disminución del <strong>63% en 2024</strong>.</li>
                                                 </p>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-12">       
                                    <div class="card">
                                        ...
                                        <p style="text-align: center;">
                                            <iframe width="674" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=1705400124&amp;format=interactive"></iframe>                                            <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                                <h4 class="card-header__title flex m-0">Interpretación: </h4>
                                                <div class="text">
                                                    <ul>
                                                        <li>El análisis de la información revela que la categoría con el mayor número de unidades es la de <strong>"0-10 días"</strong>, con un total de <strong>8384 unidades</strong>. Este intervalo de tiempo indica que una cantidad significativa de unidades inmobiliarias permanecen en el mercado durante un periodo relativamente prolongado antes de concretar la venta.</li>
                                                        <li>Por otro lado, la categoría con el menor número de unidades es la de <strong>"0-10 días"</strong>, que registra <strong>159 unidades</strong>.</strong>
                                                     </li>
                                                    </ul>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <p style="text-align: center;">
                                            <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=720990808&amp;format=interactive"></iframe>                                        <div class="card-header bg-white d-flex align-items-center"></div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <h4 class="card-header__title flex m-0">Interpretación: </h4>
                                            <div class="text">  </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">       
                                    <div class="card">
                                        ...
                                        <p style="text-align: center;">
                                            <iframe width="520" height="321" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=1602445624&amp;format=interactive"></iframe>                                        <div class="card-header bg-white d-flex align-items-center"></div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <h4 class="card-header__title flex m-0">Interpretación: </h4>
                                            <div class="text"> En este contexto, las casas que llevan más de un año en stock <strong>(3.8%)</strong> representan un riesgo menor en términos de porcentaje, pero aún así indican una proporción significativa. Por otro lado, las casas que llevan menos de un año en stock representan la mayoría en términos porcentuales <strong>(96.2%)</strong> e indican una rotación más activa del inventario.</div>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <ul class="nav navbar-nav align-items-center">
                                                <button type="button"
                            ...
                            <div class="row">
                                <div class="col-lg-12">       
                                    <div class="card">
                                        ...
                                        <p style="text-align: center;">
                                            <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=218281071&amp;format=interactive"></iframe>                                            <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                                <h4 class="card-header__title flex m-0">Interpretación: </h4>
                                                <div class="text">
                                                    <ul>
                                                        <li>En el historial de stock, se evidencia una duración de <strong>184 días</strong> en <strong>Diciembre de 2023</strong>, seguida de un aunmento a <strong>196 días</strong> en <strong>enero 2024</strong>. La proyección para <strong>Febrero y Abril</strong> sugiere una continuación de esta tendencia, con estimaciones de <strong>208 y 221 días</strong> respectivamente.</li>
        ...
        <div id="modal-large-pma"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg"
                ...
                <div class="modal-content">
                    <div class="modal-header justify-content-center align-items-center"> 
                        <div class="text-align"
                            id="modal-large-title">Interpretación</div>
                        <button type="button"
                                class="close"
                                data-dismiss="modal"
                                aria-label="Close">
        ...
        <!-- Plusvalia estimada en cinco anios -->
           ...
           <div class="modal-dialog modal-dialog-centered modal-lg"
               ...
               <div class="modal-content">
                   ...
                   <div class="modal-body text-left" style="color: black;">
                       <p>Los datos presentados ofrecen una vista anticipada del valor promedio de las propiedades en los próximos cinco años. Reflejando la posible dirección de crecimiento o reducción en el precio de las viviendas.</p>
                   </div>
               </div> <!-- // END .modal-content -->
           </div> <!-- // END .modal-dialog -->
       </div> 
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg"
          ...
          <div class="modal-content">
              ...
              <div class="modal-body text-left" style="color: black;">
                Los datos presentados ofrecen una vista anticipada del valor medio de las propiedades en los próximos cinco años. Reflejando la posible dirección de crecimiento o reducción en el precio de las viviendas.
              </div>
          </div> <!-- // END .modal-content -->
      </div> <!-- // END .modal-dialog -->
  </div> 
...
<!-- App Settings FAB -->
 ...
 <div class="modal-dialog modal-dialog-centered modal-lg"
     ...
     <div class="modal-content">
         ...
         <div class="modal-body text-left" style="color: black;">
           <ul>
            La distribución se presenta en cinco categorías según el número de días que las propiedades han estado disponibles, lo que proporciona información sobre la disponibilidad y el estado actual de las propiedades en el mercado inmobiliario.           </ul>
         </div>
     </div> <!-- // END .modal-content -->
 </div> <!-- // END .modal-dialog -->
</div> 
...
<!-- App Settings FAB -->
 ...
 <div class="modal-dialog modal-dialog-centered modal-lg"
     ...
     <div class="modal-content">
         ...
         <div class="modal-body text-left" style="color: black;">
           <ul>
            <p>La proyección poblacional es una estimación de cuántas personas se espera que vivan en una región o área geográfica específica a lo largo de varios años. En este caso, en el año 2020 se estimaba que había alrededor de 2,368,467 habitantes en esa área, y se espera que esa cifra aumente gradualmente en los años siguientes.</p>
           </ul>
         </div>
     </div> <!-- // END .modal-content -->
 </div> <!-- // END .modal-dialog -->
...
<!-- App Settings FAB -->
 ...
 <div class="modal-dialog modal-dialog-centered modal-lg"
     ...
     <div class="modal-content">
         ...
         <div class="modal-body text-left" style="color: black;">
           <p>El riesgo de stock en el mercado inmobiliario se relaciona con la cantidad de casas disponibles durante distintos lapsos de tiempo. Esta métrica es esencial para evaluar la dinámica de oferta y demanda en el sector.</p>
         </div>
     </div> <!-- // END .modal-content -->
 </div> <!-- // END .modal-dialog -->
</div> 
<!-- App Settings FAB -->
 ...
 <div class="modal-dialog modal-dialog-centered modal-lg"
     ...
     <div class="modal-content">
         ...
         <div class="modal-body text-left" style="color: black;">
           <p>La proyección en días permite anticipar la duración promedio que las propiedades podrían requerir para su venta, lo que resulta esencial para ajustar estrategias de comercialización, establecer precios competitivos y adaptarse a las dinámicas cambiantes del mercado.</p>
         </div>
     </div> <!-- // END .modal-content -->
 </div> <!-- // END .modal-dialog -->
</div> 
