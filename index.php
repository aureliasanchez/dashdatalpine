...
include("con_db.php");
                if(isset($_POST['login'])){
                    ...
                    $usuario = $conex->real_escape_string($_POST['email']);
                       ...
                       if ($usuario == $userok && $password == $passwordok) {
                           ...
                           exit(); // Asegúrate de detener la ejecución del script después de redirigir
                            ...
                            $mensaje.="<div class='alert alert-danger alert-dismissible fade show shadow-lg p-3 mb-5 bg-white rounded' role='alert'>
                                          <strong>Usuario no valido</strong> El usuario no se encuentra registrado en el sistema.
        ...
        <div class="layout-login__form bg-white"
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control form-control-prepended" placeholder="Email">
                ...
                <div class="form-group mb-5">
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="terms">
                            Acepto los
                            <a href="#" data-toggle="modal" data-target="#modal-large">
                                Términos y Condiciones, <br>
                            </a>además he leído y comprendido el Aviso de Privacidad
                        </label>
                    </div>
                </div>
                <div class="form-group text-center">
                    <button class="btn btn-primary mb-5" name="login"
                            type="submit">Entrar</button><br>
                            
                    <a href="">¿No recuerdas tu contraseña?</a> <br>
                    ¿No tienes una cuenta? <a class="text-body text-underline"
                       href="https://datalpine.mx/">Solicítala aquí</a>
                </div>
            </form>
            <div id="modal-large"
            class="modal fade"
