...
(function () {
  ...
  var Products = function Products(id) {
    ...
    data = data || {
      labels: ["Octubre 2022", "Noviembre 2022", "Febrrero 2023", "Marzo 2023", "Junio 2023", "Julio 2023"],
      datasets: [{
        label: "Earnings",
        data: [3227966.2, 3067869.3, 2807510.9, 3084920.6, 3377428.1, 3356791.5]
      }]
    };
  ...
  var Products2 = function Products2(id) {
    var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'line';
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    var data = arguments.length > 3 ? arguments[3] : undefined;
    options = Chart.helpers.merge({
    ...
    data = data || {
      ...
      datasets: [{
        label: "Earnings",
        data: [2400235.00, 2400235.00, 2500000.00, 2500000.00, 2600000.00, 2799500.00]
      }]
    };
