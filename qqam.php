                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body py-4">
                                            ...
                                            <div class="d-flex justify-content-between pb-3">
                                                ...
                                                <div>
                                                    <span> $ 49,000,000.00 </span> 
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-between pb-3">
                                                <strong>Promedio</strong>
                                                <div>
                                                    <span> $ 3,834,155.42 </span> 
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-between pb-3">
                                                <strong>Mediana</strong>
                                                <div>
                                                    <span> $ 3,190,000.00 </span> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">  
                                                <div >
                                                   <!-- <iframe src="/" width="800" height="400" frameborder="0" id="contenido01"></iframe> -->
                                ...
                                <div class="col-lg-12">       
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">  
                                                <div >
                                                    <!--<img src="/assets/images/PachucaAct.png" alt="100%" style="width: 100%;">-->
                                                    <!-- <iframe src="/pachuca_property_map_formatted.html" width="800" height="500" frameborder="0" id="contenido02" class="oculto"></iframe> -->
                                                </div>
                                            </form>
                                        </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card">
                                        ...
                                        <p style="text-align: center;">
                                            <iframe width="678" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=262931629&amp;format=interactive"></iframe>                                        </p>
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">  
                                                <div class="d-flex align-items-center">       
                                                    <iframe width="792" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=1376568436&amp;format=interactive" id="contenido1"></iframe>                                                    
                                                    <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=977109344&amp;format=interactive" id="contenido2" class="oculto"></iframe>                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text"  >
                                                <ul>
                                                    ...
                                                    <li><strong>Segmento A</strong>: Tiene una cantidad significativa de propiedades de <strong>mayor a 300 m2 </strong></li>
                                                    <li><strong>Segmento B</strong>: Destaca las propiedades con <strong>100-150m2</strong>.</li>
                                                    <li><strong>Segmento C</strong>: Las mayores concentraciones son en <strong>100-150m2</strong>.</li>
                                ...
                                <div class="col-lg-12">       
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">  
                                                <div class="d-flex align-items-center">       
                                                    <iframe width="772" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=1416575497&amp;format=interactive"></iframe>                                                    
                            ...
                            <div class="col-lg-12">       
                                <div class="card">
                                    ...
                                    <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                        <form style="text-align: center;">
                                            <div class="d-flex align-items-center">
                                                <iframe width="784" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=1252314824&amp;format=interactive" id="contenido3"></iframe>                                                    
                                                <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=300786654&amp;format=interactive" id="contenido4" class="oculto"></iframe>                                                </div>
                                        </form>      
                                    </div>
                                    <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                        <ul class="nav navbar-nav align-items-center">
                                    ...
                                    <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                        ...
                                        <div class="text"  >
                                            <ul>
                                                ...
                                                <li><strong>Segmento A </strong>: Tiene una concentración de terrenos en el rango de <strong>100-150 M2</strong>. Esto indica que los terrenos de tamaño amplio son comunes en este segmento..</li>
                                                <li><strong>Segmento B, C y D</strong>: Muestran una distribución más acentuada entre los terrenos con <strong>100-150 M2</strong> de tamaño. Esto implica que este segmento es más adecuado para aquellos que buscan terrenos de tamaño medio.</li>
                                ...
                                <div class="col-lg-12">       
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">
                                                <div class="d-flex align-items-center">
                                                    <iframe width="729" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=689443972&amp;format=interactive" id="contenido5"></iframe>                                                    
                                                    <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=190480018&amp;format=interactive" id="contenido6" class="oculto"></iframe>                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <ul class="nav navbar-nav align-items-center">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text"  > 
                                                <ul>
                                                    <li>Las propiedades con <strong>3 recámaras</strong> son las más comunes en <strong>todos los segmentos</strong>, esto se puede observar en las barras altas, con una cantidad significativa para el <strong>segmento D</strong>.</li>
                                ...
                                <div class="col-lg-12">       
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">
                                                <div class="d-flex align-items-center">
                                                    <iframe width="580" height="358" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=1478437300&amp;format=interactive" id="contenido7"></iframe>                                                    
                                                    <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=2058629581&amp;format=interactive" id="contenido8" class="oculto"></iframe>                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <ul class="nav navbar-nav align-items-center">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text"  >
                                                <ul>
                                                    <li>En el <strong>segmento S</strong>, la mayoría de las propiedades tienen <strong>6 baños</strong>. Esto se puede observar en las barras altas en este segmento para las propiedades con estos números de baños.</li>
                                                    <li>Para el <strong>segmento A</strong>, hay una distribución predominante entre propiedades con <strong>4 baños</strong>, seguido de <strong>3 baños</strong>.</li>
                                                    ...
                                                    <li>El <strong>segmento E </strong> tiene mayor propiedades en cada categoría de número de baños. En las que predominan <strong></strong>2 baños.</li>
                                ...
                                <div class="col-lg-12">       
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">
                                                <div class="d-flex align-items-center">
                                                    <iframe width="784" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=1053085278&amp;format=interactive" id="contenido9"></iframe>                                                    
                                                    <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=1102445519&amp;format=interactive" id="contenido10" class="oculto"></iframe>                                                
                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text"  > 
                                                <ul>
                                                    <li>Los <strong>segmentos A, B, C, D Y E</strong> muestran una preferencia marcada por <strong>2 estacionamiento</strong>. Esto se puede observar en las barras altas en estos segmentos para las propiedades con estos números de estacionamientos.</li>
                                                    <li>El <strong>segmento D</strong> tiene una notable cantidad de propiedades con <strong>2 estacionamientos</strong>.</li>
                                                    <li>El <strong>segmento E</strong>destaca con propiedades con de <strong>1 estacionamiento</strong> seguido de 1. Esto se puede observar en las barras altas para dicho segmento.</li>                                                
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">
                                                <div class="d-flex align-items-center">
                                                    <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=600594987&amp;format=interactive" id="contenido11"></iframe>                                                    
                                                    <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=1617870027&amp;format=interactive" id="contenido12" class="oculto"></iframe>                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <ul class="nav navbar-nav align-items-center">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <p style="text-align: center;">
                                            <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=375572345&amp;format=interactive"></iframe>                                        </p>
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text"  >
                                                <ul>
                                                    <li>Un <strong>mayor porcentaje de préstamos se otorga a hombres</strong> en el mercado inmobiliario. Los hombres tienen el <strong>53.3%</strong> de los créditos.</li>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">
                                                <div class="d-flex align-items-center">
                                                    <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=1369129422&amp;format=interactive"></iframe>                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <ul class="nav navbar-nav align-items-center">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text"  > 
                                                <ul>
                                                    <li>La mayoría de los créditos se destinan a <strong>viviendas nuevas</strong> (2453) y <strong>viviendas usadas</strong> (2047). Esto se puede observar en la barra más alta en el gráfico para viviendas nuevas.</li>
                                                    <li>Los créditos para mejoramientos son significativamente menores <strong>(569)</strong>.</li>
                                                    <li>Otros programas reciben la menor cantidad de créditos <strong>(802)</strong>.</li>
                                                </ul>
                                            </div>    
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">
                                                <div class="d-flex align-items-center">
                                                    <iframe width="792" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=504840784&amp;format=interactive" id="contenido13"></iframe>                                                    
                                                    <iframe width="600" height="344" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=2137123034&amp;format=interactive" id="contenido14" class="oculto"></iframe>                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <ul class="nav navbar-nav align-items-center">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text"> 
                                                <ul>
                                                    ...
                                                    <li>La mayoría de las personas se encuentran en la categoría <strong>“G” (52.09%)</strong>, que representa salarios entre <strong>$10 y $4,999 pesos</strong>, seguida por la categoría “F”, que incluye salarios entre <strong>$5,000 y $7,999 pesos</strong>, y en tercer lugar la categoría “F1” (10.93%) que representa salarios que ronda los <strong>$8000 a $11,999 pesos</strong> indicando que una gran proporción de individuos tiene ingresos dentro de esos rangos. A partir de la clasificación ‘E’, los porcentajes disminuyen significativamente. Las demás categorías tienen una menor proporción de personas.
                                                    </li>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">
                                                <div class="d-flex align-items-center">
                                                    <iframe width="698" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=1811336093&amp;format=interactive" id="contenido15"></iframe>                                                    
                                                    <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=802963076&amp;format=interactive" id="contenido16" class="oculto"></iframe>                                                
                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>La mayoría de las personas se encuentran en la categoría “F” (30.87%), que representa salarios entre <strong>$5000 y $7,999 pesos</strong>, seguida por la categoría “F1”, que incluye salarios entre <strong>$8,000 y $11,999 pesos</strong>, y en tercer lugar la categoría “G”(18.65%) que incluye a parejas que ganan entre <strong>$10 y $4,999 pesos</strong>. En cuarto lugar tenemos la categoría “E”(11.58%), que representa a parejas con salarios entre <strong>$12000 y $15999</strong> lo que indica la proporción de parejas con mayor participación del total dentro de los rangos salariales. A partir de la clasificación ‘E’, los porcentajes disminuyen significativamente. Las demás categorías tienen una menor proporción de personas a medida que los rangos salariales aumentan.</li>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">
                                                <div class="d-flex align-items-center">
                                                    <iframe width="900" height="293" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRphL9cL5bbuqM5zxqcaiueLghrvoCdQyDRPbp9RCYdC5pFFpbBm5jqhEEdXj3lZtNe1PvZsGy8Eupe/pubchart?oid=335056948&amp;format=interactive"></iframe>                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <ul class="nav navbar-nav align-items-center">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <table border="1">
                                                        ...
                                                        <tbody>
                                                            <!-- Columna 1 -->
                                                            <tr>
                                                                <td>Veterinarios y Zootecnistas</td>
                                                                <td>Ingenieros en Comunicaciones y Telecomunicaciones</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Presidentes y Autoridades Municipales</td>
                                                                <td>Trabajadores en otros Cultivos Agrícolas</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Escritores y Críticos Literarios</td>
                                                                <td>Pilotos de Aviación</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Entrenadores de Animales y Ocupaciones Relacionadas con el Cuidado de Mascotas</td>
                                                                <td>Coordinadores y Jefes de Área en Servicios de Transporte</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Diseñadores Gráficos</td>
                                                                <td>Ingenieros Civiles y de la Construcción</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Trabajadores en el Cultivo de Maíz Y/O Frijol</td>
                                                                <td>Coordinadores y Jefes de Área en Servicios de Salud, Protección Civil y Medio Ambiente</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Curanderos, Hierberos y Hueseros</td>
                                                                <td>Técnicos en Medicina Alternativa</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Cuidadores y Acomodadores de Autos en Estacionamientos</td>
                                                                <td>Vendedores Ambulantes de Periódicos y Lotería</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Repartidores de Mercancías (A Pie y en Bicicleta)</td>
                                                                <td>Administradores de Bases de Datos y Redes de Computadora</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Directores y Gerentes de Restaurantes y Hoteles</td>
