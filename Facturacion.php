                                ...
                                <div class="col-lg-8">
                                    <div class="card">
                                        <div class="form-group px-3 py-3">
                                            <h1 class="m-0">Datos de facturación</h1><br>
                                        </div>
                                        <div class="row px-3 card-form__body card-body">
                                            <div class="col-lg-7">
                                                <div class="form-group">
                                                    <label for="fname">*RFC:</label>
                                                    <input id="fname"
                                                           type="text"
                                                           class="form-control"
                                                           placeholder=""
                                            ...
                                            <div class="col-lg-7">
                                                <div class="form-group">
                                                    <label for="lname">*Razón Social:</label>
                                                    <input id="lname"
                                                           type="text"
                                                           class="form-control"
                                                           placeholder=""
                                            ...
                                            <div class="col-lg-5">
                                                <div class="form-group">
                                                    <label for="lname">Número Exterior:</label>
                                                    <input id="lname"
                                                           type="text"
                                                           class="form-control"
                                                           placeholder=""
                                            ...
                                            <div class="col-lg-5">
                                                <div class="form-group">
                                                    <label for="lname">Número Interior:</label>
                                                    <input id="lname"
                                                           type="text"
                                                           class="form-control"
                                                           placeholder=""
                                            ...
                                            <div class="col-lg-5">
                                                <div class="form-group">
                                                    <label for="lname">Municipio/Delegación:</label>
                                                    <input id="lname"
                                                           type="text"
                                                           class="form-control"
                                                           placeholder=""
                                            ...
                                            <div class="col-lg-10">
                                                <div class="form-group">
                                                    <label for="select01">*Régimen fiscal</label>
                                                    <select id="select01"
                                                            data-toggle="select"
                                                            class="form-control">
                                                        <option selected="">Régimen Simplificado de Confianza</option>
                                                        <option>Sueldos y salarios e ingresos asimilados a salarios</option>
                                                        <option>Régimen de Actividades Empresariales y Profesionales</option>
                                                        <option>Régimen de Incorporación Fiscal</option>
                                                        <option>Enajenación de bienes</option>
                                                        <option>Régimen de Actividades Empresariales con ingresos a través de Plataformas Tecnológicas</option>
                                                        <option>Régimen de Arrendamiento</option>
                                                        <option>Intereses</option>
                                                        <option>Obtención de premios</option>
                                                        <option>Dividendos</option>
                                                        <option>Demás ingresos</option>
                                            ...
                                            <div class="col-lg-10">
                                                <div class="form-group">
                                                    <label for="select01">*Uso Factura:</label>
                                                    <select id="select01"
                                                            data-toggle="select"
                                                            class="form-control">
                                                        <option selected="">Gastos en general</option>
                                                        <option>Adquisición de mercancías</option>
                                                        <option>Honorarios médicos, dentales y gastos hospitalarios</option>
                                                        <option>Pagos por servicios educativos (colegiaturas)</option>
                                                        <option>Devoluciones, descuentos o bonificaciones</option>
                                                        <option>Nómina</option>
                                                        <option>Sin efectos fiscales.</option>
                                                        <option>Depósitos en cuentas para el ahorro, primas que tengan como base planes de pensiones.</option>
                                                        <option>Aportaciones voluntarias al SAR.</option>
                                 ...
                                 <ul class="sidebar-menu">
                                     ...
                                     <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button"
                                           href="#">
                                            <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons" style="color: darkgray;">dvr</i>
                                            <span class="sidebar-menu-text" style="color: darkgray;">Ayuda</span>   
                                        </a>
                                    </li>
