                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card">
                                        ...
                                        <p style="text-align: center;">
                                            <iframe width="678" height="302" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQSYGWZw5iYJ2HlIsjswROVVanWxRIe98RLIDP9rK3D1ydWL12OCCWop9cjT1yUjA/pubchart?oid=120974562&amp;format=interactive"></iframe>
                                        </p>
                                ...
                                <div class="col-lg-12">       
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">  
                                                <div class="d-flex align-items-center">       
                                                    <iframe width="505" height="277" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQSYGWZw5iYJ2HlIsjswROVVanWxRIe98RLIDP9rK3D1ydWL12OCCWop9cjT1yUjA/pubchart?oid=34312089&amp;format=interactive" id="contenido1" ></iframe>
                                                    <iframe width="505" height="277" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQSYGWZw5iYJ2HlIsjswROVVanWxRIe98RLIDP9rK3D1ydWL12OCCWop9cjT1yUjA/pubchart?oid=2051073085&amp;format=interactive" id="contenido2" class="oculto"></iframe>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text"  >
                                                <ul>
                                                    <li><strong>Segmento S</strong>: Posee una alta concentración de propiedades con un tamaño de construcción mayor a los <strong>300 m2</strong>.</li>
                                                    <li><strong>Segmento A</strong>: Tiene una cantidad significativa de propiedades de <strong>0-100m2 de construcción</strong>.</li>
                                                    <li><strong>Segmento B</strong>: Destaca las propiedades con <strong>100-150m2</strong>, seguido de <strong>150-200m2 de construcción</strong>.</li>
                                                    <li><strong>Segmento C</strong>: Las mayores concentraciones son en <strong>200-250m2</strong>, seguido de <strong>150-200m2 de construcción</strong>.</li>
                                                    <li><strong>Segmento D</strong>: Posee los valores más cercanos a la media presupuestal y tiene una distribución equitativa. Destaca las propiedades con un tamaño de construcción mayor a los <strong>200-250M2</strong> y mayor a <strong>300M2 de construcción</strong>.</li>
                                                    <li><strong>Segmento E</strong>: Tiene pocos terrenos en m2 de construcción en todos los rangos. Esto podría indicar que este segmento tiene una oferta limitada de terrenos debido a su poco valor en el mercado.</li>
                                ...
                                <div class="col-lg-12">       
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">  
                                                <div class="d-flex align-items-center">       
                                                    <iframe width="745" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQX6HV4iKEsF0uJ-dxHXixMFO_MfPxGthAhgbiLQ6shDr3WLOJSL5BAYESXBXj-Kg/pubchart?oid=1369974359&amp;format=interactive"></iframe>                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <ul class="nav navbar-nav align-items-center">
                                ...
                                <div class="col-lg-12">       
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">
                                                <div class="d-flex align-items-center">
                                                    <iframe width="505" height="277" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQSYGWZw5iYJ2HlIsjswROVVanWxRIe98RLIDP9rK3D1ydWL12OCCWop9cjT1yUjA/pubchart?oid=1000474932&amp;format=interactive" id="contenido3"></iframe>
                                                    <iframe width="505" height="277" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQSYGWZw5iYJ2HlIsjswROVVanWxRIe98RLIDP9rK3D1ydWL12OCCWop9cjT1yUjA/pubchart?oid=1949167&amp;format=interactive" id="contenido4" class="oculto"></iframe>
                                                </div>
                                            </form>      
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text"  >
                                                <ul>
                                                    <li><strong>Segmento S</strong>: Predominan los terrenos con <strong>150-200 M2</strong>. Esto significa que en este segmento hay una gran cantidad de terrenos construidos de tamaño medio-amplio.</li>
                                                    <li><strong>Segmento A </strong>: Tiene una concentración de terrenos en el rango de <strong>100-150 M2</strong>. Esto indica que los terrenos de tamaño medio son comunes en este segmento.</li>
                                                    <li><strong>Segmento B, C y D</strong>: Muestran una distribución más acentuada entre los terrenos con 100-150 M2 de tamaño. Esto implica que este segmento es más adecuado para aquellos que buscan terrenos de tamaño medio.</li>
                                                    ...
                                                    <p>Esto puede ayudar a los compradores a entender qué tamaños de terreno son más comunes en cada segmento.</p>
                                                </ul>
                                            </div>    
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">       
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">
                                                <div class="d-flex align-items-center">
                                                    <iframe width="505" height="277" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQSYGWZw5iYJ2HlIsjswROVVanWxRIe98RLIDP9rK3D1ydWL12OCCWop9cjT1yUjA/pubchart?oid=193822603&amp;format=interactive" id="contenido5" ></iframe>
                                                    <iframe width="505" height="277" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQSYGWZw5iYJ2HlIsjswROVVanWxRIe98RLIDP9rK3D1ydWL12OCCWop9cjT1yUjA/pubchart?oid=1251189756&amp;format=interactive" id="contenido6" class="oculto"></iframe>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text"  > 
                                                <ul>
                                                    <li>Las propiedades con <strong>3 recámaras</strong> son las más comunes en <strong>todos los segmentos</strong>, esto se puede observar en las barras altas, con una cantidad significativa para el <strong>segmento B</strong>.</li>
                                                    <li>Subsiguiente, las propiedades con <strong>2 recámaras</strong> también son populares en el <strong>segmento A y B</strong>. En contraste, las propiedades con <strong>4 o más recámaras</strong> en los <strong>segmentos C y D</strong>.</li>
                                                </ul>
                                            </div>    
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">       
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">
                                                <div class="d-flex align-items-center">
                                                    <iframe width="505" height="277" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQSYGWZw5iYJ2HlIsjswROVVanWxRIe98RLIDP9rK3D1ydWL12OCCWop9cjT1yUjA/pubchart?oid=267105551&amp;format=interactive" id="contenido7" ></iframe>
                                                    <iframe width="505" height="277" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQSYGWZw5iYJ2HlIsjswROVVanWxRIe98RLIDP9rK3D1ydWL12OCCWop9cjT1yUjA/pubchart?oid=559601624&amp;format=interactive" id="contenido8" class="oculto"></iframe>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text"  >
                                                <ul>
                                                    <li>En el <strong>segmento S</strong>, la mayoría de las propiedades tienen <strong>3 y 5 baños</strong>. Esto se puede observar en las barras altas en este segmento para las propiedades con dicho números de baños.</li>
                                                    <li>Para el <strong>segmento A</strong>, hay una distribución más uniforme entre propiedades con <strong>2 baños</strong> seguido de <strong>1 baño</strong>.</li>
                                                    <li>El <strong>segmento B</strong> muestra una predominancia de propiedades con <strong>3 baños</strong>. Esto se puede observar en la barra alta en este segmento para las propiedades, seguido de <strong>2 baños</strong>.</li>
                                                    <li>En los <strong>segmentos C y D</strong>, la mayoría de las propiedades es común encontrar entre <strong>2 a 4 baños</strong>.</li>
                                                    <li>El <strong>segmento E </strong>tiene muy pocas propiedades en cada categoría de número de baños. Esto se puede observar en las barras bajas en este segmento para las propiedades con cualquier número de baños, predominando <strong>2 baños</strong>.</li>
                                ...
                                <div class="col-lg-12">       
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">
                                                <div class="d-flex align-items-center">
                                                    <iframe width="505" height="277" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQSYGWZw5iYJ2HlIsjswROVVanWxRIe98RLIDP9rK3D1ydWL12OCCWop9cjT1yUjA/pubchart?oid=201297974&amp;format=interactive" id="contenido9" ></iframe>
                                                    <iframe width="505" height="277" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQSYGWZw5iYJ2HlIsjswROVVanWxRIe98RLIDP9rK3D1ydWL12OCCWop9cjT1yUjA/pubchart?oid=810337920&amp;format=interactive" id="contenido10" class="oculto"></iframe>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text"  > 
                                                <ul>
                                                    <li>La mayoría de las propiedades en todos los segmentos <strong>tienen 2 lugares de estacionamiento</strong> seguido de 1 estacionamiento. Esto se puede observar en las barras altas en estos segmentos para las propiedades con estos números de estacionamientos.</li>
                                                    <li>El <strong>segmento S</strong> tiene una notable cantidad de propiedades con <strong>2 estacionamientos.</strong></li>
                                                    <li>Los <strong>segmentos A, B, C, D Y E</strong> muestran una preferencia marcada por <strong>2 estacionamientos</strong>. Esto se puede observar en la barra alta en estos segmentos para las propiedades seguido de 1 estacionamiento.</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">
                                                <div class="d-flex align-items-center">
                                                    <iframe width="505" height="277" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQSYGWZw5iYJ2HlIsjswROVVanWxRIe98RLIDP9rK3D1ydWL12OCCWop9cjT1yUjA/pubchart?oid=1187310010&amp;format=interactive" id="contenido11" ></iframe>
                                                    <iframe width="505" height="277" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQSYGWZw5iYJ2HlIsjswROVVanWxRIe98RLIDP9rK3D1ydWL12OCCWop9cjT1yUjA/pubchart?oid=1979983403&amp;format=interactive" id="contenido12" class="oculto"></iframe>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text">
                                                <ul>
                                                    <p>La mayoría de las viviendas en <strong>todos los segmentos</strong> tienden a tener una antigüedad <strong>mayor a los 13 meses</strong> antes de ser <strong>vendidas</strong>. Esto indica que las viviendas para dicho mercado  requieren de más tiempo para encontrar comprador.</p>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <p style="text-align: center;">
                                            <iframe width="678" height="302" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQSYGWZw5iYJ2HlIsjswROVVanWxRIe98RLIDP9rK3D1ydWL12OCCWop9cjT1yUjA/pubchart?oid=1534510743&amp;format=interactive"></iframe>
                                        </p>
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text"  >
                                                <ul>
                                                    <li>Un <strong>mayor porcentaje de préstamos se otorga a hombres</strong> en el mercado inmobiliario. Los hombres tienen el <strong>54.4%</strong> de los créditos.</li>
                                                    <li>Las mujeres tienen el <strong>45.6%</strong> de los créditos. Esto indica que un <strong>menor porcentaje de préstamos se otorga a mujeres</strong>.</li>
                                                </ul>
                                            </div>    
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">
                                                <div class="d-flex align-items-center">
                                                    <iframe width="505" height="277" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQSYGWZw5iYJ2HlIsjswROVVanWxRIe98RLIDP9rK3D1ydWL12OCCWop9cjT1yUjA/pubchart?oid=39174196&amp;format=interactive"></iframe>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text"  > 
                                                <ul>
                                                    <li>La mayoría de los créditos se destinan a <strong>viviendas nuevas</strong> (838). Esto se puede observar en la barra más alta en el gráfico para las viviendas nuevas.</li>
                                                    <li>Los créditos para <strong>viviendas usadas</strong> son también significativos (772).</li>
                                                    <li>Los créditos para <strong>mejoramientos</strong> son significativamente menores (255).</li>
                                                    <li><strong>Otros programas</strong> reciben la menor cantidad de créditos (154).</li>
                                                </ul>
                                            </div>    
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">
                                                <div class="d-flex align-items-center">
                                                <iframe width="740" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQX6HV4iKEsF0uJ-dxHXixMFO_MfPxGthAhgbiLQ6shDr3WLOJSL5BAYESXBXj-Kg/pubchart?oid=1595438112&amp;format=interactive" id="contenido13"></iframe>                                                    
                                                    <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQX6HV4iKEsF0uJ-dxHXixMFO_MfPxGthAhgbiLQ6shDr3WLOJSL5BAYESXBXj-Kg/pubchart?oid=1947506489&amp;format=interactive" id="contenido14" class="oculto"></iframe>                                                
                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text"> 
                                                <ul>
                                                    ...
                                                    <li>La mayoría de las personas se encuentran en la <strong>categoría “F” (30.03%)</strong>, que representa salarios entre <strong>$5000 y $7,999 pesos</strong>, seguida por la <strong>categoría “F1”(25.56%)</strong>, que incluye salarios entre <strong>$8,000 y $11,999 pesos</strong>, y en tercer lugar la <strong>categoría “G” (23.32%)</strong> que representa salarios que ronda los <strong>$10 y $4,999 pesos</strong> indicando que una gran proporción de individuos tiene ingresos dentro de esos rangos. <strong>A partir</strong> de la <strong>clasificación “E” y”E1”</strong>, los <strong>porcentajes disminuyen</strong> significativamente. Las demás categorías tienen una menor proporción de personas.</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">
                                                <div class="d-flex align-items-center">
                                                <iframe width="789" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQX6HV4iKEsF0uJ-dxHXixMFO_MfPxGthAhgbiLQ6shDr3WLOJSL5BAYESXBXj-Kg/pubchart?oid=1111030631&amp;format=interactive" id="contenido15"></iframe>                                                    
                                                    <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQX6HV4iKEsF0uJ-dxHXixMFO_MfPxGthAhgbiLQ6shDr3WLOJSL5BAYESXBXj-Kg/pubchart?oid=1476014986&amp;format=interactive" id="contenido16" class="oculto"></iframe>                                                    
                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text">
                                                <ul>
                                                    ...
                                                    <li>La mayoría de las parejas se encuentran en la <strong>categoría “F1” (24.00%)</strong>, que representa salarios entre <strong>$8000 y $11,999 pesos</strong>, seguida por la <strong>categoría “E” (18.46%)</strong>, que incluye salarios entre <strong>$12000 y $15,999 pesos</strong>, y en tercer lugar la <strong>categoría “F”(14.46%)</strong> que incluye a parejas que ganan entre <strong>$5000 y $7,999 pesos</strong>. Dichos segmentos representan la proporción de parejas con mayor participación del total dentro de los rangos salariales. Las demás categorías tienen una menor proporción.</li>
                                                    <li>Esta gráfica nos permite comprender de manera efectiva cómo se distribuyen los salarios en el mercado laboral y dónde se encuentra un elemento específico dentro de este mercado. Es una herramienta útil para analizar la estructura salarial de la población.
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">
                                                <div class="d-flex align-items-center">
                                                    <iframe width="1064" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQX6HV4iKEsF0uJ-dxHXixMFO_MfPxGthAhgbiLQ6shDr3WLOJSL5BAYESXBXj-Kg/pubchart?oid=719432948&amp;format=interactive"></iframe>                                                                                                    
                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                        ...
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            ...
                                            <div class="text"  > 
                                                <ul>
                                                    <li>Las barras están coloreadas para representar visualmente cada rango de ingreso; hay una barra verde, una amarilla y café que son prominentes porque representan los volúmenes salariales netos más altos. Los valores exactos del volumen salarial están indicados en cada barra para proporcionar detalles precisos.</li>
                                                    <li>Se observa que la categoría color verde de ingresos de <strong>$8000-$11999(F1)</strong> tiene el volumen salarial más alto, seguido por la categoría de <strong>$5000-$8999 (F)</strong>. Las categorías con ingresos superiores a 25K(D1) en adelante tienen un volumen salarial significativamente menor.</li>
                                                    ...
                                                    <table border="1">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>JCoordinadores y Jefes de Área en Generación y Provisión de Energía Eléctrica y Agua</td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td>Operadores de Máquinas para el Tratamiento de Agua</td>
