                        ...
                        <div class="container-fluid page__container">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header bg-white d-flex align-items-center">
                                            <h4 class="card-header__title m-0"> 1.2 Distribución de la población por edad y género</h4>
                                        </div>
                                        <p style="text-align: center;">
                                            <iframe width="840" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=468148079&amp;format=interactive"></iframe>                                        
                                        <div class="card-header bg-white d-flex align-items-center">
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <h4 class="card-header__title flex m-0">Descripción: </h4>
                                            <body>
                                                <div class="text">Distribución de la estructura demográfica de la población de Tulancingo por grupos de edad y género, se tiene un registro de <p class="cantidades">168,282</p> habitantes de los cuales los menores de <p class="cantidades">29</p> años representan <p class="porcentaje">23.2%, </p>, personas de <p class="cantidades">30 a 60 años </p>con <p class="porcentaje">34.8%</p>, y mayores de <p class="cantidades">64 años</p> con <p class="porcentaje">7.6%</p>.</div>
                                            </body>                                        
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                    <form style="text-align: center;">
                                        <div class="d-flex align-items-center">>
                                            <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=159177271&amp;format=interactive"></iframe>
                                        </form>
                                    </div>
                                </div>
                                <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                    ...
                                    <div>
                                        ...
                                        <div class="text">
                                            <p>La gráfica de pastel revela que: <p class="porcentaje">77.9%</p> de los titulares de créditos tienen entre <p class="cantidades">30 y 59</p> años, destacando la actividad crediticia de este grupo. Asimismo, el <p class="porcentaje">18.4%</p> de personas menores de <p class="cantidades">29</p> años muestra cierta inclusión financiera en este segmento más joven, mientras que el <p class="porcentaje">3.8%</p>  de personas mayores de <p class="cantidades">60 años</p> con créditos sugiere su participación en actividades financieras.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="card">
                                        ...
                                        <p style="text-align: center;">
                                            <iframe width="827" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=1380799156&amp;format=interactive"></iframe>                                        <div class="card-header bg-white d-flex align-items-center">                                             
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <h4 class="card-header__title flex m-0">Descripción: </h4> 
                                            <div class="column-container">
                                                <div >
                                                    <p>Precios de oferta para viviendas desde Mayo de 2022 hasta Noviembre de 2023. Explora la tendencia de los precios de las casas en este periodo de tiempo para la toma de decisiones inteligentes.</p>
                                                    <ul>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <p style="text-align: center;">
                                            <iframe width="827" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=779138857&amp;format=interactive"></iframe>                                        </p>
                                        <div class="card-header bg-white d-flex align-items-center">                                             
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <h4 class="card-header__title flex m-0">Descripción: </h4> 
                                            <div class="text">Representación de la mediana de precios en el mercado durante el período de 2022-2023. Observa una vista general en la tendencia de precios medianos en el mercado de viviendas durante el periodo considerado.
                                                <div>
                                                    <ul>
                            ...
                            <div class="row">
                                <div class="col-lg-12">       
                                    <div class="card">
                                        ...
                                        <p style="text-align: center;">
                                            <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=676872837&amp;format=interactive"></iframe>                                            <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <h4 class="card-header__title flex m-0">Descripción: </h4>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card">
                                        <div class="card-header bg-white d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <input type="button" class="btn btn-outline-dark" onclick="mostrar('contenido1') & ocultar('contenido4')" value="2022">
                                                <input type="button" class="btn btn-outline-dark" onclick="mostrar('contenido2') & ocultar('contenido3')" value="2023">
                                            </div> 
                                        </div>
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">  
                                                <div class="d-flex align-items-center">
                                                    <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=1980100793&amp;format=interactive" id="contenido1"></iframe>                                                    
                                                    <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=1731173811&amp;format=interactive" id="contenido2" class="oculto"></iframe>                                                
                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <p style="text-align: center;">
                                            <iframe width="874" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=371658743&amp;format=interactive"></iframe>                                        </p>
                                        <div class="card-header bg-white d-flex align-items-center">
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <h4 class="card-header__title flex m-0" >Descripción: </h4>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <p style="text-align: center;">
                                            <iframe width="678" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=934665195&amp;format=interactive"></iframe>                                            <div class="card-header bg-white d-flex align-items-center"></div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <h4 class="card-header__title flex m-0" >Descripción: </h4>
                                            <div class="text">Variación y cambio precios que se han presentado en cada trimestre del 2023, correspondientes a las diferentes clasificaciones y/o segmentos de mercado.<br><br>
                                                <div>
                                                    <ul>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">  
                                                <div class="d-flex align-items-center">       
                                                    <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=882348772&amp;format=interactive" id="contenido3"></iframe>                                                    
                                                    <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=326572423&amp;format=interactive" id="contenido4" class="oculto"></iframe>                                                
                                                </div>
                                            </form>
                                        </div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                    <form style="text-align: center;">  
                                        <div class="d-flex align-items-center"> 
                                            <iframe width="937" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=103044073&amp;format=interactive" id="contenido10"></iframe>                                            
                                            <iframe width="880" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=644147129&amp;format=interactive" id="contenido11" class="oculto"></iframe>                                        </div>
                                    </form>
                                </div>
                                <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                    <h4 class="card-header__title flex m-0" >Descripción: </h4>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">  
                                                <div class="d-flex align-items-center">
                                                    <iframe width="846" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=445792562&amp;format=interactive" id="contenido5"></iframe>                                                    
                                                    <iframe width="791" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=1412878543&amp;format=interactive" id="contenido6" class="oculto"></iframe>                                                
                                                </div>
                                            </form>
                                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                    <form style="text-align: center;">  
                                        <div class="d-flex align-items-center">
                                            <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=2140054990&amp;format=interactive" id="contenido18"></iframe>
                                            <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=692788987&amp;format=interactive" id="contenido19" class="oculto"></iframe>
                                            <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=896076719&amp;format=interactive" id="contenido20" class="oculto"></iframe>
                                            <iframe width="706" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=206832242&amp;format=interactive" id="contenido12" class="oculto"></iframe>                                            
                                            <iframe width="718" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=1413397505&amp;format=interactive" id="contenido13" class="oculto"></iframe>                                        
                                        </div>
                                    </form>
                                </div>
                                <div class="px-4 py-3" style="background-color: #FAFBFE;">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <p style="text-align: center;">
                                            <iframe width="868" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=752836162&amp;format=interactive"></iframe>                                        </p>
                                        <div class="card-header bg-white d-flex align-items-center"></div>
                                        <div class="px-4 py-3" style="background-color: #FAFBFE;">
                                            <h4 class="card-header__title flex m-0" >Descripción: </h4>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                            <form style="text-align: center;">  
                                                <div class="d-flex align-items-center">
                                                    <iframe width="852" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=1945417595&amp;format=interactive" id="contenido7"></iframe>                                                    
                                                    <iframe width="706" height="400" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=2073286039&amp;format=interactive" id="contenido8" class="oculto"></iframe>                                                
                                                </div>
                                            </form>
                                        </div>
                                        <div class="card-header bg-white d-flex align-items-center"></div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                    <form style="text-align: center;">  
                                        <div class="d-flex align-items-center">
                                            <iframe width="790" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=978826170&amp;format=interactive" id="contenido14"></iframe>                                            
                                            <iframe width="743" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=1555247294&amp;format=interactive" id="contenido15" class="oculto"></iframe>
                                        </div>
                                    </form>
                                </div>
                                <div class="px-4 py-3" style="background-color: #FAFBFE;">
                            ...
                            <div class="card">
                                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <input type="button" class="btn btn-outline-dark" onclick="mostrar('contenido16') & ocultar('contenido16')" value="2022">
                                        <input type="button" class="btn btn-outline-dark" onclick="mostrar('contenido17') & ocultar('contenido17')" value="2023">
                                    </div>
                                </div>
                                <div class="card-header bg-white d-flex justify-content-center align-items-center">
                                    <form style="text-align: center;">  
                                        <div class="d-flex align-items-center">
                                            <iframe width="696" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=1464828317&amp;format=interactive" id="contenido16"></iframe>                                            
                                            <iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQHuBNh281rfcjLd6FPg9LNU-EKpcVq3hiH75-rsMn3jYhazirg3MDrzvUnUU1Lom7B8is9sbuOBr_k/pubchart?oid=1933884330&amp;format=interactive" id="contenido17" class="oculto"></iframe>                                        
                                        </div>
                                    </form>
                                </div>
                                <div class="px-4 py-3" style="background-color: #FAFBFE;">
